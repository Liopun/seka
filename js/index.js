...
function Flip(id) {
	...
	if (NoStop) {
     ...
     if (memory_values.length < 2) {
         ...
         if (id=='im0') { a = memory_arrays[0] + ""; aClass="#N1"; }
         if (id=='im1') { a = memory_arrays[1] + ""; aClass="#N2"; }
         if (id=='im2') { a = memory_arrays[2] + ""; aClass="#N3"; }
         if (id=='im3') {a = memory_arrays[3] + ""; aClass="#N4"; } 
         if (id=='im4') { a = memory_arrays[4] + ""; aClass="#N5"; }
         if (id=='im5') { a = memory_arrays[5] + ""; aClass="#N6"; }
         if (id=='im6') { a = memory_arrays[6] + ""; aClass="#N7" ;}
         if (id=='im7') { a = memory_arrays[7] + ""; aClass="#N8"; }
         if (id=='im8') { a = memory_arrays[8] + ""; aClass="#N9"; }
         if (id=='im9') {a = memory_arrays[9] + ""; aClass="#N10"; } 
         if (id=='im10') { a = memory_arrays[10] + ""; aClass="#N11"; }
         if (id=='im11') {a = memory_arrays[11] + ""; aClass="#N12"; } 
         if (id=='im12') {a = memory_arrays[12] + ""; aClass="#N13"; } 
         if (id=='im13')  {a = memory_arrays[13] + ""; aClass="#N14" ;}
         if (id=='im14') {a = memory_arrays[14] + ""; aClass="#N15" ;} 
         if (id=='im15') {a = memory_arrays[15] + ""; aClass="#N16" ;} 
         if (id=='im16') {a = memory_arrays[16] + ""; aClass="#N17" ;} 
         if (id=='im17') {a = memory_arrays[17] + ""; aClass="#N18" ;} 
         if (id=='im18') {a = memory_arrays[18] + ""; aClass="#N19"; } 
         if (id=='im19') {a = memory_arrays[19] + ""; aClass="#N20" ;} 
...
function AlertCustom() {
    this.render = function() {
      ...
      $('#Case').attr('src','Win.png');
      $('#But2').attr('src','Button2.png');
    ...
    this.renderFail = function() {
      ...
      var Alertback = document.getElementById("AlertBack");
      var Alertbox = document.getElementById("AlertBox");
      $('#Known').attr('src','Sorry.png');
      $('#Case').attr('src','Fail.png');
      $('#But2').attr('src','Button.png');
